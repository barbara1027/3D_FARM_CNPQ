...
export function normalizeMaterial(m: any) {
  return {
    ...
    tempBicoRecomendada: m.tempBicoRecomendada != null ? Number(m.tempBicoRecomendada) : null,
    tempMesaMin:         m.tempMesaMin         != null ? Number(m.tempMesaMin)         : null,
    tempMesaMax:         m.tempMesaMax         != null ? Number(m.tempMesaMax)         : null,
    tempMesaRecomendada: m.tempMesaRecomendada != null ? Number(m.tempMesaRecomendada) : null,
